...
FPGA technology. My responsibilities included:\\
    \begin{contributionlist}
      \contribution{Design the high-level FPGA hardware system that integrates 
IP blocks and peripherals using Qsys tool from Altera}
...
Tasks included::\\
    \begin{contributionlist}
      ...
      \contribution{Customize the bootloader U-Boot, including the development a 
user interface to configure it through an LCD graphic display and a matrix 
keypad}
      \contribution{Develop firmware for ARM using FreeRTOS and port it to be 
loaded through the network using U-Boot}
      \contribution{Develop a complete functional testing system to be used in 
